...
class _SyncScreenState extends State<SyncScreen>{
  ...
  Future<void> load()async{rows=await AppDatabase.instance.queue();if(mounted)setState((){});}
  @override Widget build(BuildContext context)=>SingleChildScrollView(padding:const EdgeInsets.all(24),child:Column(crossAxisAlignment:CrossAxisAlignment.start,children:[
    ...
    const SizedBox(height:4),const Text('OFFLINE-FIRST SYNCHRONIZATION CONTROL',style:TextStyle(fontSize:10,fontWeight:FontWeight.w700,color:Color(0xFF748094))),
